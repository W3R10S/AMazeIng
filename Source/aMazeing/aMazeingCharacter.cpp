...
void AaMazeingCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &AaMazeingCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &AaMazeingCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AaMazeingCharacter::OnResetVR);
}


void AaMazeingCharacter::OnResetVR()
{
	// If aMazeing is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in aMazeing.Build.cs is not automatically propagated
...
void AaMazeingCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void AaMazeingCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
